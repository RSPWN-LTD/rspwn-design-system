import{j as o}from"./jsx-runtime-CDt2p4po.js";import{r as X}from"./index-GiUgBvb1.js";import{l,d as x}from"./styled-components.browser.esm-Byilhkxn.js";import{p as Y}from"./propFilters-BGSNtaQt.js";const Z=(r,a)=>{const s=l`
  ...
  `;switch(r){case"filled":return l`
      ...
      `;default:return l`
        ${n}
        ${a&&s}
      `}},ee=r=>{switch(r){case"sm":return l`
      ...
      `;default:return l`
        ...
        height: 40px;
      `}},re=x.div.withConfig({shouldForwardProp:r=>!["fullWidth"].includes(r)})`
  display: inline-flex;
  flex-direction: column;
  gap: ${({theme:r})=>r.spacing[1]};
  ${({fullWidth:r})=>r&&l`width: 100%;`}
`,ae=x.input.withConfig({shouldForwardProp:Y.input})`
...
`,t=X.forwardRef(({variant:r="default",size:a="md",error:s=!1,fullWidth:n=!1,label:e,helperText:G,errorText:g,className:J,...K},Q)=>{const b=s&&g?g:G;return o.jsxs(re,{fullWidth:n,className:J,children:[e&&o.jsx(oe,{children:e}),o.jsx(ae,{ref:Q,variant:r,size:a,error:s,fullWidth:n,...K}),b&&o.jsx(te,{error:s,children:b})]})});t.displayName="Input";try{t.displayName="Input",t.__docgenInfo={description:"",displayName:"Input",props:{variant:{defaultValue:{value:"default"},description:"",name:"variant",required:!1,type:{name:"enum",value:[{value:'"default"'},{value:'"filled"'},{value:'"outline"'}]}},size:{defaultValue:{value:"md"},description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},error:{defaultValue:{value:"false"},description:"",name:"error",required:!1,type:{name:"boolean"}},fullWidth:{defaultValue:{value:"false"},description:"",name:"fullWidth",required:!1,type:{name:"boolean"}},label:{defaultValue:null,description:"",name:"label",required:!1,type:{name:"string"}},helperText:{defaultValue:null,description:"",name:"helperText",required:!1,type:{name:"string"}},errorText:{defaultValue:null,description:"",name:"errorText",required:!1,type:{name:"string"}}}}}catch{}const de={title:"UI/Input",component:t,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{variant:{control:{type:"select"},options:["default","filled","outline"]},size:{control:{type:"select"},options:["sm","md","lg"]},error:{control:{type:"boolean"}},fullWidth:{control:{type:"boolean"}},disabled:{control:{type:"boolean"}}}},i={args:{placeholder:"Enter text...",variant:"default",size:"md"}},d={args:{label:"Email Address",placeholder:"Enter your email",type:"email"}},p={args:{label:"Username",placeholder:"Enter username",helperText:"Must be at least 3 characters long"}},c={render:()=>o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"1rem",width:"300px"},children:[o.jsx(t,{variant:"default",placeholder:"Default variant"}),o.jsx(t,{variant:"filled",placeholder:"Filled variant"}),o.jsx(t,{variant:"outline",placeholder:"Outline variant"})]})},u={render:()=>o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"1rem",width:"300px"},children:[o.jsx(t,{size:"sm",placeholder:"Small input"}),o.jsx(t,{size:"md",placeholder:"Medium input"}),o.jsx(t,{size:"lg",placeholder:"Large input"})]})},m={render:()=>o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"1rem",width:"300px"},children:[o.jsx(t,{placeholder:"Normal state"}),o.jsx(t,{placeholder:"Disabled state",disabled:!0}),o.jsx(t,{placeholder:"Error state",error:!0,errorText:"This field is required"})]})},h={args:{label:"Password",type:"password",placeholder:"Enter password",error:!0,errorText:"Password must be at least 8 characters"}},y={render:()=>o.jsx("div",{style:{width:"400px"},children:o.jsx(t,{label:"Full Width Input",placeholder:"This input takes full width",fullWidth:!0,helperText:"This input spans the full container width"})})},f={render:()=>o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"1rem",width:"300px"},children:[o.jsx(t,{type:"text",placeholder:"Text input",label:"Text"}),o.jsx(t,{type:"email",placeholder:"Email input",label:"Email"}),o.jsx(t,{type:"password",placeholder:"Password input",label:"Password"}),o.jsx(t,{type:"number",placeholder:"Number input",label:"Number"}),o.jsx(t,{type:"search",placeholder:"Search input",label:"Search"})]})};var $,v,w;i.parameters={...i.parameters,docs:{...($=i.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
...
}`,...(k=(D=c.parameters)==null?void 0:D.docs)==null?void 0:k.source}}};var P,V,_;u.parameters={...u.parameters,docs:{...(P=u.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '1rem',
...
}`,...(_=(V=u.parameters)==null?void 0:V.docs)==null?void 0:_.source}}};var q,B,F;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '1rem',
...
}`,...(F=(B=m.parameters)==null?void 0:B.docs)==null?void 0:F.source}}};var N,L,H;h.parameters={...h.parameters,docs:{...(N=h.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    label: 'Password',
    type: 'password',
...
}`,...(U=(O=y.parameters)==null?void 0:O.docs)==null?void 0:U.source}}};var A,C,R;f.parameters={...f.parameters,docs:{...(A=f.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '1rem',
...
}`,...(R=(C=f.parameters)==null?void 0:C.docs)==null?void 0:R.source}}};const pe=["Default","WithLabel","WithHelperText","Variants","Sizes","States","ErrorState","FullWidth","Types"];export{i as Default,h as ErrorState,y as FullWidth,u as Sizes,m as States,f as Types,c as Variants,p as WithHelperText,d as WithLabel,pe as __namedExportsOrder,de as default};
