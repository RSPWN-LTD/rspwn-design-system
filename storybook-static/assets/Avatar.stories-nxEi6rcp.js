import{j as e}from"./jsx-runtime-CDt2p4po.js";import{r as ue}from"./index-GiUgBvb1.js";import{l as n,d as l}from"./styled-components.browser.esm-Byilhkxn.js";import{c as ge}from"./propFilters-BGSNtaQt.js";import{B as t}from"./Box-COihqxSe.js";import{T as i}from"./Typography-u4LxpgYF.js";const fe=a=>{switch(a){case"xs":return n`
        width: 24px;
        height: 24px;
      ...
      `}},he=a=>{switch(a){case"online":return"#22c55e";case"away":return"#f59e0b";case"busy":return"#ef4444";case"offline":default:return"#6b7280"}},ye=a=>a.split(" ").map(s=>s.charAt(0)).slice(0,2).join("").toUpperCase(),ve=l.div.withConfig({shouldForwardProp:ge(["size","variant","src","alt","name","icon","status","showStatus","loading","onError"])})`
  position: relative;
  display: inline-flex;
  align-items: center;
...
`,be=l.img`
  ...
  height: 100%;
  object-fit: cover;
`,je=l.div.withConfig({shouldForwardProp:a=>!["status","size"].includes(a)})`
  position: absolute;
  border: 2px solid ${({theme:a})=>a.colors.foundation.black};
  border-radius: ${({theme:a})=>a.radius.full};
  background-color: ${({$status:a})=>he(a)};
  ...
  ${({$size:a})=>{switch(a){case"xs":case"sm":return n`
        ...
        `;default:return n`
          ...
          right: 0;
        `}}}
`,we=l.div.withConfig({shouldForwardProp:a=>!["size"].includes(a)})`
...
}`,...(W=(M=c.parameters)==null?void 0:M.docs)==null?void 0:W.source}}};var J,q,C;p.parameters={...p.parameters,docs:{...(J=p.parameters)==null?void 0:J.docs,source:{originalSource:`{
...
}`,...(C=(q=p.parameters)==null?void 0:q.docs)==null?void 0:C.source}}};var T,O,$;m.parameters={...m.parameters,docs:{...(T=m.parameters)==null?void 0:T.docs,source:{originalSource:`{
...
}`,...($=(O=m.parameters)==null?void 0:O.docs)==null?void 0:$.source}}};var k,E,L;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => <Box display="flex" gap="md" alignItems="center" flexWrap="wrap">\r
...
}`,...(L=(E=d.parameters)==null?void 0:E.docs)==null?void 0:L.source}}};var H,F,V;x.parameters={...x.parameters,docs:{...(H=x.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => <Box display="flex" gap="md" alignItems="center" flexWrap="wrap">\r
      <Box display="flex" flexDirection="column" alignItems="center" gap="sm">\r
...
}`,...(V=(F=x.parameters)==null?void 0:F.docs)==null?void 0:V.source}}};var Q,X,_;u.parameters={...u.parameters,docs:{...(Q=u.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: () => <Box display="flex" gap="md" alignItems="center" flexWrap="wrap">\r
...
}`,...(_=(X=u.parameters)==null?void 0:X.docs)==null?void 0:_.source}}};var G,P,N;g.parameters={...g.parameters,docs:{...(G=g.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => <Box display="flex" gap="md" alignItems="center" flexWrap="wrap">\r
...
}`,...(N=(P=g.parameters)==null?void 0:P.docs)==null?void 0:N.source}}};var R,U,K;f.parameters={...f.parameters,docs:{...(R=f.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => <Box display="flex" gap="md" alignItems="center" flexWrap="wrap">\r
...
}`,...(K=(U=f.parameters)==null?void 0:U.docs)==null?void 0:K.source}}};var Y,Z,ee;h.parameters={...h.parameters,docs:{...(Y=h.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => <Box display="flex" gap="md" alignItems="center" flexWrap="wrap">\r
...
}`,...(se=(re=y.parameters)==null?void 0:re.docs)==null?void 0:se.source}}};const We=["Default","WithImage","Sizes","Variants","WithInitials","WithStatus","WithCustomIcon","Loading","ErrorFallback","ClickableAvatars","Group"];export{h as ClickableAvatars,o as Default,f as ErrorFallback,y as Group,g as Loading,p as Sizes,m as Variants,u as WithCustomIcon,c as WithImage,d as WithInitials,x as WithStatus,We as __namedExportsOrder,Me as default};
