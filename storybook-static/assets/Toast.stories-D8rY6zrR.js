import{j as e}from"./jsx-runtime-CDt2p4po.js";import{B as r}from"./Button-CmnvKrIY.js";import{r as d}from"./index-GiUgBvb1.js";import{r as Wt}from"./index-CROobee-.js";import{l as g,d as l,m as E}from"./styled-components.browser.esm-Byilhkxn.js";const It=d.createContext(void 0),P=(t="default")=>({default:g`
...
`,Ot=l.div`
  ...
  svg {
    ...
    ${({variant:t})=>{switch(t){case"success":return`color: ${({theme:s})=>s.colors.semantic.success};`;case"error":return`color: ${({theme:s})=>s.colors.semantic.error};`;case"warning":return`color: ${({theme:s})=>s.colors.semantic.warning};`;case"info":return`color: ${({theme:s})=>s.colors.innovation.primaryBlue};`;default:return`color: ${({theme:s})=>s.colors.innovation.primaryBlue};`}}}
  }
`,Vt=l.div`
  flex: 1;
  min-width: 0;
...
`,Qt=({toast:t,isRemoving:s,onDismiss:o})=>e.jsxs(Lt,{variant:t.variant,isRemoving:s,children:[e.jsxs(Nt,{children:[e.jsx(Ot,{variant:t.variant,children:W(t.variant)}),e.jsxs(Vt,{children:[t.title&&e.jsx(Ft,{children:t.title}),t.description&&e.jsx(Ht,{children:t.description}),t.action&&e.jsx(Yt,{children:e.jsx(Xt,{onClick:t.action.onClick,children:t.action.label})})]})]}),t.dismissible!==!1&&e.jsx(qt,{onClick:()=>o(t.id),"aria-label":"Close notification",children:e.jsx("svg",{viewBox:"0 0 14 14",fill:"none",children:e.jsx("path",{d:"M10.5 3.5L3.5 10.5M3.5 3.5l7 7",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),M=({children:t})=>{const[s,o]=d.useState([]),[h,u]=d.useState(new Set),p=d.useCallback(a=>{u(n=>new Set([...n,a])),setTimeout(()=>{o(n=>n.filter(c=>c.id!==a)),u(n=>{const c=new Set(n);return c.delete(a),c})},300)},[]),I=d.useCallback(a=>{const n=Math.random().toString(36).substr(2,9),c={id:n,duration:4e3,dismissible:!0,...a};return o(Pt=>[...Pt,c]),c.duration&&c.duration>0&&setTimeout(()=>{p(n)},c.duration),n},[p]),_=d.useCallback(()=>{const a=s.map(n=>n.id);u(new Set(a)),setTimeout(()=>{o([]),u(new Set)},300)},[s]),_t={toasts:s,toast:I,dismiss:p,dismissAll:_};return e.jsxs(It.Provider,{value:_t,children:[t,Wt.createPortal(e.jsx(Rt,{children:s.map(a=>e.jsx(Qt,{toast:a,isRemoving:h.has(a.id),onDismiss:p},a.id))}),document.body)]})};try{M.displayName="ToastProvider",M.__docgenInfo={description:"",displayName:"ToastProvider",props:{}}}catch{}const m=()=>{const t=d.useContext(It);if(!t)throw new Error("useToast must be used within ToastProvider");return t},ee={title:"UI/Toast",parameters:{layout:"centered"},tags:["autodocs"],decorators:[t=>e.jsx(M,{children:e.jsx(t,{})})]},i=({variant:t,title:s,description:o,duration:h,action:u,dismissible:p=!0})=>{const{toast:I}=m(),_=()=>{I({variant:t,title:s,description:o,duration:h,dismissible:p,...u&&{action:{label:"Undo",onClick:()=>console.log("Action clicked")}}})};return e.jsxs(r,{onClick:_,children:["Show ",t||"default"," toast"]})},f={render:()=>e.jsx(i,{title:"Default notification",description:"This is a default toast notification."})},v={render:()=>e.jsx(i,{variant:"success",title:"Success!",description:"Your changes have been saved successfully."})},y={render:()=>e.jsx(i,{variant:"error",title:"Error occurred",description:"Failed to save your changes. Please try again."})},x={render:()=>e.jsx(i,{variant:"warning",title:"Warning",description:"This action cannot be undone."})},b={render:()=>e.jsx(i,{variant:"info",title:"Information",description:"New features are available in this update."})},T={render:()=>e.jsx(i,{variant:"success",title:"File deleted",description:"Your file has been moved to trash.",action:!0})},w={render:()=>e.jsx(i,{variant:"success",title:"Changes saved"})},$={render:()=>e.jsx(i,{variant:"info",description:"This toast only has a description without a title."})},S={render:()=>e.jsx(i,{variant:"warning",title:"System maintenance",description:"This notification cannot be dismissed.",dismissible:!1,duration:0})},k={render:()=>e.jsxs("div",{style:{display:"flex",gap:"1rem"},children:[e.jsx(i,{variant:"info",title:"Quick toast",description:"This will disappear in 1 second.",duration:1e3}),e.jsx(i,{variant:"warning",title:"Long toast",description:"This will stay for 10 seconds.",duration:1e4}),e.jsx(i,{variant:"error",title:"Persistent toast",description:"This won't auto-dismiss.",duration:0})]})},j={render:()=>{const{toast:t}=m(),s=()=>{t({variant:"default",title:"Default Toast",description:"This is a default notification."}),setTimeout(()=>{t({variant:"success",title:"Success Toast",description:"Operation completed successfully."})},200),setTimeout(()=>{t({variant:"error",title:"Error Toast",description:"Something went wrong."})},400),setTimeout(()=>{t({variant:"warning",title:"Warning Toast",description:"Please be careful."})},600),setTimeout(()=>{t({variant:"info",title:"Info Toast",description:"Here is some information."})},800)};return e.jsx(r,{onClick:s,children:"Show All Variants"})}},C={render:()=>{const{toast:t}=m(),s=()=>{for(let o=1;o<=5;o++)setTimeout(()=>{t({variant:o%2===0?"success":"info",title:`Toast ${o}`,description:`This is toast number ${o} of 5.`})},o*150)};return e.jsx(r,{onClick:s,children:"Show Multiple Toasts"})}},B={render:()=>{const{toast:t,dismissAll:s}=m(),o=()=>{t({variant:"info",title:"Toast 1",description:"First toast",duration:0}),t({variant:"success",title:"Toast 2",description:"Second toast",duration:0}),t({variant:"warning",title:"Toast 3",description:"Third toast",duration:0})};return e.jsxs("div",{style:{display:"flex",gap:"1rem"},children:[e.jsx(r,{onClick:o,children:"Show Some Toasts"}),e.jsx(r,{variant:"destructive",onClick:s,children:"Dismiss All"})]})}},D={render:()=>{const{toast:t}=m(),s=[{label:"Save Document",action:()=>t({variant:"success",title:"Document saved",description:"Your changes have been automatically saved."})},{label:"Delete Item",action:()=>t({variant:"success",title:"Item deleted",description:"The item has been moved to trash.",action:{label:"Undo",onClick:()=>console.log("Undo delete")}})},{label:"Network Error",action:()=>t({variant:"error",title:"Connection failed",description:"Unable to connect to the server. Please check your internet connection.",duration:6e3})},{label:"Form Validation",action:()=>t({variant:"warning",title:"Missing required fields",description:"Please fill in all required fields before submitting."})},{label:"Update Available",action:()=>t({variant:"info",title:"Update available",description:"A new version of the application is ready to install.",action:{label:"Update",onClick:()=>console.log("Start update")},duration:0})},{label:"File Upload",action:()=>{t({variant:"info",title:"Uploading file...",description:"Please wait while your file is being uploaded.",dismissible:!1,duration:2e3}),setTimeout(()=>{t({variant:"success",title:"Upload complete",description:"Your file has been uploaded successfully."})},2500)}}];return e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gap:"1rem",width:"400px"},children:s.map((o,h)=>e.jsx(r,{variant:"outline",onClick:o.action,children:o.label},h))})}},z={render:()=>e.jsx(i,{variant:"info",title:"This is a very long title that might wrap to multiple lines in the toast notification",description:"This is a very long description that contains a lot of text to test how the toast handles content that might be longer than expected. It should wrap properly and maintain good readability while staying within reasonable bounds."})},A={render:()=>{const{toast:t}=m();return e.jsxs("div",{children:[e.jsx("h3",{style:{color:"white",marginBottom:"1rem"},children:"Toast Playground"}),e.jsx("p",{style:{color:"white",marginBottom:"2rem",fontSize:"0.875rem"},children:"Try different combinations of toasts. They stack nicely and animate smoothly."}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:"0.75rem",maxWidth:"600px"},children:[e.jsx(r,{size:"sm",onClick:()=>t({title:"Simple"}),children:"Simple"}),e.jsx(r,{size:"sm",variant:"outline",onClick:()=>t({variant:"success",title:"Success!",description:"Task completed."}),children:"Success"}),e.jsx(r,{size:"sm",variant:"destructive",onClick:()=>t({variant:"error",title:"Error!",description:"Something went wrong."}),children:"Error"}),e.jsx(r,{size:"sm",onClick:()=>t({variant:"warning",title:"Warning!",description:"Please be careful."}),children:"Warning"}),e.jsx(r,{size:"sm",onClick:()=>t({variant:"info",title:"Info",description:"Here is some information."}),children:"Info"}),e.jsx(r,{size:"sm",onClick:()=>t({title:"With Action",description:"Try the action button.",action:{label:"Action",onClick:()=>{}}}),children:"With Action"})]})]})}};var U,R,L;f.parameters={...f.parameters,docs:{...(U=f.parameters)==null?void 0:U.docs,source:{originalSource:`{
...
}`,...(et=(tt=T.parameters)==null?void 0:tt.docs)==null?void 0:et.source}}};var ot,st,it;w.parameters={...w.parameters,docs:{...(ot=w.parameters)==null?void 0:ot.docs,source:{originalSource:`{
  render: () => <ToastDemo variant="success" title="Changes saved" />
}`,...(it=(st=w.parameters)==null?void 0:st.docs)==null?void 0:it.source}}};var rt,at,nt;$.parameters={...$.parameters,docs:{...(rt=$.parameters)==null?void 0:rt.docs,source:{originalSource:`{
...
}`,...(At=(zt=A.parameters)==null?void 0:zt.docs)==null?void 0:At.source}}};const oe=["Default","Success","Error","Warning","Info","WithAction","TitleOnly","DescriptionOnly","NonDismissible","CustomDuration","AllVariants","MultipleToasts","DismissAll","RealWorldExamples","LongContent","Playground"];export{j as AllVariants,k as CustomDuration,f as Default,$ as DescriptionOnly,B as DismissAll,y as Error,b as Info,z as LongContent,C as MultipleToasts,S as NonDismissible,A as Playground,D as RealWorldExamples,v as Success,w as TitleOnly,x as Warning,T as WithAction,oe as __namedExportsOrder,ee as default};
