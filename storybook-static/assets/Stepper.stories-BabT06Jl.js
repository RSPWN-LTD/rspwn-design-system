import{j as e}from"./jsx-runtime-CDt2p4po.js";import{r as S}from"./index-GiUgBvb1.js";import{l as p,d as y}from"./styled-components.browser.esm-Byilhkxn.js";import{B as a}from"./Box-COihqxSe.js";import{T as n}from"./Typography-u4LxpgYF.js";import{B as v}from"./Button-B5_6KITS.js";import"./propFilters-BGSNtaQt.js";const De=t=>{switch(t){case"sm":return p`
        .step-indicator {
          width: 24px;
          height: 24px;
...
`,We=y.div`
  ...
  ${({status:t,theme:r,variant:s})=>{switch(t){case"completed":return p`
        ...
        `;case"active":return p`
          background-color: ${s==="dots"?r.colors.innovation.primaryBlue:r.colors.foundation.black};
          border-color: ${r.colors.innovation.primaryBlue};
          color: ${r.colors.foundation.white};
...
`,Ee=y.div`
  ...
  ${({orientation:t})=>t==="vertical"&&p`
    ...
    `}
`,He=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"60%",height:"60%",children:e.jsx("path",{d:"M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"})}),qe=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"60%",height:"60%",children:e.jsx("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"})}),i=({steps:t,activeStep:r,onStepClick:s,nonLinear:x=!1,orientation:l="horizontal",getStepStatus:g,size:u="md",variant:d="default",disabled:W=!1,showContent:Be=!1,className:we,"aria-label":ze,"aria-describedby":ke,...$e})=>{const N=S.useMemo(()=>{const o=c=>c<r?"completed":c===r?"active":"pending";return t.map((c,b)=>({...c,status:g?g(b,c):o(b)}))},[t,r,g]),O=(o,c)=>{if(W)return;(x||o<=r||N[o].status==="completed")&&s&&s(o,c)},f=t[r];return e.jsxs("div",{className:we,...$e,children:[e.jsx(Ve,{orientation:l,size:u,variant:d,disabled:W,"data-orientation":l,role:"tablist","aria-label":ze||"Step indicator","aria-describedby":ke,children:N.map((o,c)=>{const b=!W&&(x||c<=r||o.status==="completed"),Ie=c===t.length-1;return e.jsxs(Pe,{orientation:l,variant:d,children:[e.jsxs(Le,{orientation:l,children:[e.jsx(We,{className:"step-indicator",status:o.status,clickable:b,variant:d,role:"tab","aria-selected":c===r,"aria-current":c===r?"step":void 0,tabIndex:b?0:-1,onClick:()=>O(c,o),onKeyDown:M=>{(M.key==="Enter"||M.key===" ")&&(M.preventDefault(),O(c,o))},children:o.status==="completed"&&d!=="dots"?e.jsx(He,{}):o.status==="error"&&d!=="dots"?e.jsx(qe,{}):o.icon&&d!=="dots"?o.icon:d==="dots"?null:c+1}),!Ie&&e.jsx(Me,{className:"step-connector",status:o.status==="completed"?"completed":"pending",orientation:l})]}),d!=="dots"&&e.jsxs(Ae,{orientation:l,variant:d,children:[e.jsx(Ne,{className:"step-label",status:o.status,optional:o.optional,children:o.label}),o.description&&e.jsx(Oe,{className:"step-description",status:o.status,children:o.description})]})]},o.id)})}),Be&&(f==null?void 0:f.content)&&e.jsx(Ee,{orientation:l,children:f.content})]})};try{i.displayName="Stepper",i.__docgenInfo={description:"",displayName:"Stepper",props:{steps:{defaultValue:null,description:"",name:"steps",required:!0,type:{name:"Step[]"}},activeStep:{defaultValue:null,description:"",name:"activeStep",required:!0,type:{name:"number"}},onStepClick:{defaultValue:null,description:"",name:"onStepClick",required:!1,type:{name:"((stepIndex: number, step: Step) => void)"}},nonLinear:{defaultValue:{value:"false"},description:"",name:"nonLinear",required:!1,type:{name:"boolean"}},orientation:{defaultValue:{value:"horizontal"},description:"",name:"orientation",required:!1,type:{name:"enum",value:[{value:'"vertical"'},{value:'"horizontal"'}]}},getStepStatus:{defaultValue:null,description:"",name:"getStepStatus",required:!1,type:{name:"((stepIndex: number, step: Step) => StepStatus)"}},size:{defaultValue:{value:"md"},description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},variant:{defaultValue:{value:"default"},description:"",name:"variant",required:!1,type:{name:"enum",value:[{value:'"default"'},{value:'"compact"'},{value:'"dots"'}]}},disabled:{defaultValue:{value:"false"},description:"",name:"disabled",required:!1,type:{name:"boolean"}},showContent:{defaultValue:{value:"false"},description:"",name:"showContent",required:!1,type:{name:"boolean"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},"aria-label":{defaultValue:null,description:"",name:"aria-label",required:!1,type:{name:"string"}},"aria-describedby":{defaultValue:null,description:"",name:"aria-describedby",required:!1,type:{name:"string"}}}}}catch{}const Xe={title:"UI/Stepper",component:i,parameters:{layout:"padded"},tags:["autodocs"],argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["default","compact","dots"]},activeStep:{control:{type:"number",min:0,max:4}}}},m=[{id:"account",label:"Account Setup"},{id:"profile",label:"Profile Information"},{id:"preferences",label:"Gaming Preferences"},{id:"verification",label:"Email Verification"},{id:"complete",label:"Complete"}],h=[{id:"personal",label:"Personal Information",description:"Enter your basic personal details"},{id:"gaming",label:"Gaming Setup",description:"Configure your gaming preferences and hardware"},{id:"payment",label:"Payment Method",description:"Add your payment information",optional:!0},{id:"review",label:"Review & Confirm",description:"Review all information before submitting"}],A=[{id:"design",label:"Design",description:"Create initial design mockups",content:e.jsxs(a,{p:"md",children:[e.jsx(n,{variant:"body",mb:"md",children:"Design Phase"}),e.jsx(n,{variant:"small",color:"gray",children:"In this phase, we create wireframes and mockups for the new gaming interface. This includes user experience research and visual design iterations."})]})},{id:"development",label:"Development",description:"Implement the designed features",content:e.jsxs(a,{p:"md",children:[e.jsx(n,{variant:"body",mb:"md",children:"Development Phase"}),e.jsx(n,{variant:"small",color:"gray",children:"Our development team implements the designed features using React and TypeScript. This includes component development, state management, and API integration."})]})},{id:"testing",label:"Testing",description:"Quality assurance and bug fixing",content:e.jsxs(a,{p:"md",children:[e.jsx(n,{variant:"body",mb:"md",children:"Testing Phase"}),e.jsx(n,{variant:"small",color:"gray",children:"Comprehensive testing including unit tests, integration tests, and user acceptance testing. We ensure all gaming features work correctly across different devices."})]})},{id:"deployment",label:"Deployment",description:"Release to production environment",content:e.jsxs(a,{p:"md",children:[e.jsx(n,{variant:"body",mb:"md",children:"Deployment Phase"}),e.jsx(n,{variant:"small",color:"gray",children:"Deploy the new features to production servers with proper monitoring and rollback procedures. This includes performance optimization and security checks."})]})}],j={args:{steps:m,activeStep:2,orientation:"horizontal",size:"md",variant:"default"}},C={render:()=>{const[t,r]=S.useState(1);return e.jsx(a,{display:"flex",flexDirection:"column",gap:"lg",p:"md",children:e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Interactive Stepper"}),e.jsx(i,{steps:m,activeStep:t,onStepClick:s=>r(s),nonLinear:!0}),e.jsxs(a,{display:"flex",gap:"sm",mt:"lg",justifyContent:"center",children:[e.jsx(v,{variant:"outline",size:"sm",onClick:()=>r(Math.max(0,t-1)),disabled:t===0,children:"Previous"}),e.jsx(v,{size:"sm",onClick:()=>r(Math.min(m.length-1,t+1)),disabled:t===m.length-1,children:"Next"})]}),e.jsxs(n,{variant:"small",color:"gray",mt:"md",textAlign:"center",children:["Current Step: ",t+1," - ",m[t].label]})]})})}},T={render:()=>e.jsxs(a,{display:"flex",flexDirection:"column",gap:"xl",p:"md",children:[e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Horizontal Stepper"}),e.jsx(i,{steps:h,activeStep:1,orientation:"horizontal"})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Vertical Stepper"}),e.jsx(a,{maxWidth:"400px",children:e.jsx(i,{steps:h,activeStep:1,orientation:"vertical"})})]})]})},B={render:()=>e.jsxs(a,{display:"flex",flexDirection:"column",gap:"lg",p:"md",children:[e.jsxs("div",{children:[e.jsx(n,{variant:"small",mb:"sm",color:"gray",children:"Small"}),e.jsx(i,{steps:m,activeStep:2,size:"sm"})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"small",mb:"sm",color:"gray",children:"Medium"}),e.jsx(i,{steps:m,activeStep:2,size:"md"})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"small",mb:"sm",color:"gray",children:"Large"}),e.jsx(i,{steps:m,activeStep:2,size:"lg"})]})]})},w={render:()=>e.jsxs(a,{display:"flex",flexDirection:"column",gap:"xl",p:"md",children:[e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Default Variant"}),e.jsx(i,{steps:h,activeStep:1,variant:"default"})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Compact Variant"}),e.jsx(i,{steps:m,activeStep:2,variant:"compact"})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Dots Variant"}),e.jsx(i,{steps:m,activeStep:2,variant:"dots"})]})]})},z={render:()=>{const[t,r]=S.useState(0);return e.jsxs(a,{display:"flex",flexDirection:"column",gap:"md",p:"md",maxWidth:"800px",children:[e.jsx(n,{variant:"body",mb:"md",children:"Stepper with Content"}),e.jsx(i,{steps:A,activeStep:t,showContent:!0,onStepClick:r,nonLinear:!0}),e.jsxs(a,{display:"flex",gap:"sm",justifyContent:"center",mt:"lg",children:[e.jsx(v,{variant:"outline",onClick:()=>r(Math.max(0,t-1)),disabled:t===0,children:"Previous"}),e.jsx(v,{onClick:()=>r(Math.min(A.length-1,t+1)),disabled:t===A.length-1,children:"Next"})]})]})}},k={render:()=>{const t=[{id:"step1",label:"Completed Step"},{id:"step2",label:"Current Step"},{id:"step3",label:"Error Step"},{id:"step4",label:"Pending Step"},{id:"step5",label:"Another Pending"}],r=s=>{switch(s){case 0:return"completed";case 1:return"active";case 2:return"error";default:return"pending"}};return e.jsxs(a,{display:"flex",flexDirection:"column",gap:"lg",p:"md",children:[e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Custom Step Status"}),e.jsx(i,{steps:t,activeStep:1,getStepStatus:r}),e.jsx(n,{variant:"small",color:"gray",mt:"sm",children:"Steps can have custom status independent of the active step"})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Vertical with Custom Status"}),e.jsx(a,{maxWidth:"400px",children:e.jsx(i,{steps:t.map(s=>({...s,description:`Status: ${r(t.indexOf(s))}`})),activeStep:1,getStepStatus:r,orientation:"vertical"})})]})]})}},$={render:()=>{const t=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"60%",height:"60%",children:e.jsx("path",{d:"M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"})}),r=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"60%",height:"60%",children:e.jsx("path",{d:"M21 6H3c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zM11 13H9v2H8v-2H6v-1h2V10h1v2h2v1zm4.5 2c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm3-3c-.83 0-1.5-.67-1.5-1.5S17.67 9 18.5 9s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"})}),s=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"60%",height:"60%",children:e.jsx("path",{d:"M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"})}),x=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",width:"60%",height:"60%",children:e.jsx("path",{d:"M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"})}),l=[{id:"profile",label:"Create Profile",description:"Set up your gaming profile",icon:e.jsx(t,{})},{id:"games",label:"Select Games",description:"Choose your favorite games",icon:e.jsx(r,{})},{id:"payment",label:"Payment Setup",description:"Add payment method",icon:e.jsx(s,{})},{id:"complete",label:"All Set!",description:"Ready to start gaming",icon:e.jsx(x,{})}];return e.jsxs(a,{display:"flex",flexDirection:"column",gap:"lg",p:"md",children:[e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Custom Icons"}),e.jsx(i,{steps:l,activeStep:1})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Custom Icons - Vertical"}),e.jsx(a,{maxWidth:"400px",children:e.jsx(i,{steps:l,activeStep:2,orientation:"vertical"})})]})]})}},I={render:()=>{const[t,r]=S.useState(1),[s,x]=S.useState([0,1]),l=u=>{r(u),x(d=>[...new Set([...d,u])])},g=u=>s.includes(u)&&u!==t?"completed":u===t?"active":"pending";return e.jsx(a,{display:"flex",flexDirection:"column",gap:"lg",p:"md",children:e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Non-linear Navigation"}),e.jsx(n,{variant:"small",color:"gray",mb:"md",children:"Click on any step to navigate freely between them"}),e.jsx(i,{steps:h,activeStep:t,onStepClick:l,getStepStatus:g,nonLinear:!0}),e.jsxs(a,{display:"flex",gap:"sm",mt:"lg",justifyContent:"center",children:[e.jsx(v,{variant:"outline",size:"sm",onClick:()=>l(Math.max(0,t-1)),disabled:t===0,children:"Previous"}),e.jsx(v,{size:"sm",onClick:()=>l(Math.min(h.length-1,t+1)),disabled:t===h.length-1,children:"Next"})]}),e.jsxs(n,{variant:"small",color:"gray",mt:"md",textAlign:"center",children:["Visited steps: ",s.sort().map(u=>u+1).join(", ")]})]})})}},D={render:()=>e.jsxs(a,{display:"flex",flexDirection:"column",gap:"lg",p:"md",children:[e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"sm",children:"Normal State"}),e.jsx(i,{steps:m,activeStep:2})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"sm",children:"Disabled State"}),e.jsx(i,{steps:m,activeStep:2,disabled:!0})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"sm",children:"With Optional Steps"}),e.jsx(i,{steps:h,activeStep:1})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"sm",children:"All Completed"}),e.jsx(i,{steps:m,activeStep:4})]})]})},V={render:()=>{const[t,r]=S.useState(0),[s,x]=S.useState(2),l=[{id:"email",label:"Email Verification",description:"Verify your email address"},{id:"profile",label:"Create Profile",description:"Set up your gaming profile"},{id:"preferences",label:"Gaming Preferences",description:"Choose your favorite game genres"},{id:"complete",label:"Welcome!",description:"Account setup complete"}],g=[{id:"cart",label:"Shopping Cart"},{id:"shipping",label:"Shipping Info"},{id:"payment",label:"Payment"},{id:"review",label:"Review Order"},{id:"confirmation",label:"Confirmation"}],u=[{id:"planning",label:"Planning",description:"Define project scope and requirements"},{id:"design",label:"Design",description:"Create UI/UX designs and prototypes"},{id:"development",label:"Development",description:"Build and implement features"},{id:"testing",label:"Testing",description:"Quality assurance and bug fixes"},{id:"launch",label:"Launch",description:"Deploy to production"}];return e.jsxs(a,{display:"flex",flexDirection:"column",gap:"xl",p:"md",children:[e.jsxs("div",{children:[e.jsx(n,{variant:"h3",mb:"lg",children:"User Onboarding"}),e.jsxs(a,{maxWidth:"600px",children:[e.jsx(i,{steps:l,activeStep:t,onStepClick:r,nonLinear:!0}),e.jsxs(a,{display:"flex",gap:"sm",mt:"lg",justifyContent:"center",children:[e.jsx(v,{variant:"outline",onClick:()=>r(Math.max(0,t-1)),disabled:t===0,children:"Back"}),e.jsx(v,{onClick:()=>r(Math.min(l.length-1,t+1)),disabled:t===l.length-1,children:t===l.length-1?"Finish":"Continue"})]})]})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"h3",mb:"lg",children:"Order Process"}),e.jsxs(a,{maxWidth:"500px",children:[e.jsx(i,{steps:g,activeStep:s,variant:"compact"}),e.jsxs(n,{variant:"small",color:"gray",mt:"sm",textAlign:"center",children:["Step ",s+1," of ",g.length,": ",g[s].label]})]})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"h3",mb:"lg",children:"Project Timeline"}),e.jsx(a,{maxWidth:"400px",children:e.jsx(i,{steps:u,activeStep:2,orientation:"vertical",getStepStatus:d=>d<2?"completed":d===2?"active":"pending"})})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"h3",mb:"lg",children:"Progress Indicator"}),e.jsxs(a,{display:"flex",flexDirection:"column",gap:"md",children:[e.jsx(n,{variant:"small",color:"gray",children:"Loading Progress"}),e.jsx(i,{steps:[{id:"1",label:"Initializing"},{id:"2",label:"Loading Assets"},{id:"3",label:"Connecting"},{id:"4",label:"Ready"}],activeStep:1,variant:"dots",size:"sm"})]})]})]})}},P={render:()=>e.jsxs(a,{display:"flex",flexDirection:"column",gap:"lg",p:"md",maxWidth:"600px",children:[e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Accessibility Features"}),e.jsx(i,{steps:h,activeStep:1,"aria-label":"Account setup process with accessibility features",nonLinear:!0}),e.jsx(n,{variant:"small",color:"gray",mt:"sm",children:"This stepper supports keyboard navigation (Tab to focus, Enter/Space to activate steps) and screen reader announcements for step status changes."})]}),e.jsxs("div",{children:[e.jsx(n,{variant:"body",mb:"md",children:"Keyboard Navigation"}),e.jsx(n,{variant:"small",color:"gray",mb:"md",children:"Try using Tab to navigate between steps, and Enter or Space to select them."}),e.jsx(i,{steps:m,activeStep:2,onStepClick:()=>{},nonLinear:!0,"aria-describedby":"keyboard-help"}),e.jsx(n,{id:"keyboard-help",variant:"small",color:"gray",mt:"sm",children:"Use Tab key to navigate between clickable steps, Enter or Space to select."})]})]})},L={args:{steps:h,activeStep:1,orientation:"horizontal",size:"md",variant:"default",nonLinear:!1,disabled:!1,showContent:!1},render:t=>e.jsx(a,{display:"flex",justifyContent:"center",p:"md",maxWidth:"800px",margin:"0 auto",children:e.jsx(i,{...t})})};var E,H,q;j.parameters={...j.parameters,docs:{...(E=j.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    steps: basicSteps,
    activeStep: 2,
...
}`,...(q=(H=j.parameters)==null?void 0:H.docs)==null?void 0:q.source}}};var U,R,_;C.parameters={...C.parameters,docs:{...(U=C.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: () => {
...
}`,...(_=(R=C.parameters)==null?void 0:R.docs)==null?void 0:_.source}}};var G,F,K;T.parameters={...T.parameters,docs:{...(G=T.parameters)==null?void 0:G.docs,source:{originalSource:`{
...
}`,...(K=(F=T.parameters)==null?void 0:F.docs)==null?void 0:K.source}}};var Q,X,J;B.parameters={...B.parameters,docs:{...(Q=B.parameters)==null?void 0:Q.docs,source:{originalSource:`{
...
}`,...(J=(X=B.parameters)==null?void 0:X.docs)==null?void 0:J.source}}};var Y,Z,ee;w.parameters={...w.parameters,docs:{...(Y=w.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => <Box display="flex" flexDirection="column" gap="xl" p="md">\r
      <div>\r
...
}`,...(ee=(Z=w.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var te,re,ne;z.parameters={...z.parameters,docs:{...(te=z.parameters)==null?void 0:te.docs,source:{originalSource:`{
  render: () => {
...
}`,...(ne=(re=z.parameters)==null?void 0:re.docs)==null?void 0:ne.source}}};var ie,ae,se;k.parameters={...k.parameters,docs:{...(ie=k.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => {
    const steps: Step[] = [{
      id: 'step1',
...
}`,...(se=(ae=k.parameters)==null?void 0:ae.docs)==null?void 0:se.source}}};var oe,le,pe;$.parameters={...$.parameters,docs:{...(oe=$.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: () => {
...
}`,...(pe=(le=$.parameters)==null?void 0:le.docs)==null?void 0:pe.source}}};var ce,de,me;I.parameters={...I.parameters,docs:{...(ce=I.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  render: () => {
    const [currentStep, setCurrentStep] = useState(1);
...
}`,...(me=(de=I.parameters)==null?void 0:de.docs)==null?void 0:me.source}}};var ue,ge,he;D.parameters={...D.parameters,docs:{...(ue=D.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  render: () => <Box display="flex" flexDirection="column" gap="lg" p="md">\r
      <div>\r
...
}`,...(he=(ge=D.parameters)==null?void 0:ge.docs)==null?void 0:he.source}}};var ye,ve,xe;V.parameters={...V.parameters,docs:{...(ye=V.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  render: () => {
...
}`,...(xe=(ve=V.parameters)==null?void 0:ve.docs)==null?void 0:xe.source}}};var Se,be,fe;P.parameters={...P.parameters,docs:{...(Se=P.parameters)==null?void 0:Se.docs,source:{originalSource:`{
...
}`,...(fe=(be=P.parameters)==null?void 0:be.docs)==null?void 0:fe.source}}};var je,Ce,Te;L.parameters={...L.parameters,docs:{...(je=L.parameters)==null?void 0:je.docs,source:{originalSource:`{
  args: {
    steps: detailedSteps,
    activeStep: 1,
    orientation: 'horizontal',
...
}`,...(Te=(Ce=L.parameters)==null?void 0:Ce.docs)==null?void 0:Te.source}}};const Je=["Default","BasicUsage","Orientations","Sizes","Variants","WithContent","CustomStepStatus","CustomIcons","NonLinearNavigation","States","RealWorldExamples","AccessibilityDemo","Playground"];export{P as AccessibilityDemo,C as BasicUsage,$ as CustomIcons,k as CustomStepStatus,j as Default,I as NonLinearNavigation,T as Orientations,L as Playground,V as RealWorldExamples,B as Sizes,D as States,w as Variants,z as WithContent,Je as __namedExportsOrder,Xe as default};
